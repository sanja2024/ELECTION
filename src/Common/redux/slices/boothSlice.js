...
export const getPollStatusList = createAsyncThunk(
    "poll/getPollStatusList",
    async (reqParamData, { rejectWithValue }) => {
        try {
...
const boothSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getPollStatusList.pending, (state) => {
                state.loading = "pending";
            })
            .addCase(getPollStatusList.fulfilled, (state, action) => {
                state.loading = "fulfilled";
                state.pollData = action.payload;
            })
            .addCase(getPollStatusList.rejected, (state, action) => {
                state.loading = "rejected";
                state.error = action.error.message;
            })
